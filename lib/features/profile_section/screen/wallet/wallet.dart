...
class _WalletScreenState extends State<WalletScreen> {
  ...
  final transactions = [
    {"title": "Order Refund", "type": "credit", "amount": "+₹120", "date": "26 Dec 2025 • 11:20 AM"},
    {"title": "Order Payment", "type": "debit", "amount": "-₹240", "date": "25 Dec 2025 • 09:40 PM"},
    {"title": "Wallet Added", "type": "credit", "amount": "+₹300", "date": "23 Dec 2025 • 05:10 PM"},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text("My Wallet"), backgroundColor: Colors.white, elevation: 1),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Transaction History", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16)),
